...
export default function Navbar() {
    return (
        <nav className='fixed z-50 bg-neutral-50 w-full border-b border-neutral-900'>
            <section className='flex justify-between max-w-4xl m-auto h-11'>
                <Link href="/">
                    <a className='tracking-widest text-xl border-neutral-900 hover:bg-neutral-900 hover:text-neutral-50 px-6 flex justify-center items-center'>
